...
const handlePaypalPayment = async () => {
  ...
  return (
    <div>
      ...
      <hr className="border-t-4 border-gray-300 mx-4 lg:mx-20 mt-3 w-[90%]" />
      </div>
   <div className="flex max-w-[800px] m-auto xl:m-0 gap-20 p-2">
    ...
    {!isCollapsed && ( 
     <div className="md:min-w-xl items-start mx-2 xl:ml-35 bg-white shadow-lg rounded-sm">
      <h2 className="text-xl bg-gray-300 px-4 py-2 font-bold mb-7 md:mb-2">Attendee Details :</h2> 
     ...
     <form onSubmit={handleSubmit} className="grid gap-4 px-2">
        <div>
          ...
          <input type="text" name="fullName" value={formData.fullName} onChange={handleChange} required className="w-full p-1 border-b-1 border-gray-400 outline-none" />
        </div>
        <div>
            ...
            <input 
              ...
              required 
              className="w-full p-1 border-b-1 border-gray-400 outline-none" 
            />
         ...
         <div>
            ...
            <input 
              ...
              className="w-full p-1 border-b-1 border-gray-400 outline-none" 
            />
            {confirmEmailError && <p className="text-red-400 text-[10px] font-semibold mt-1">{confirmEmailError}</p>}
          </div>
        <div>
      ...
      <PhoneInput
          ...
          inputStyle={{
           ...
           borderBottom: "1px solid #9CA3AF", // Add only bottom border
    ...
    />
        ...
        <div>
          ...
          <input type="text" name="city" value={formData.city} onChange={handleChange} required className="w-full p-1 border-b-1 border-gray-400 outline-none" />
        </div>
        <div>
          <label className="block">How did you hear about us? <span className="text-red-500">*</span></label>
          <select name="referralSource" value={formData.referralSource} onChange={handleChange} required className="w-full p-2 border-b-1 border-gray-400 outline-none">
      ...
      {
          showSaveButton ? (
            <button  onClick={handleMobileSubmit} className="xl:hidden bg-blue-500 text-white text-xl mx-auto py-5 mt-4 rounded-xl w-full">Save Information</button>
          ) : (
   ...
   {  /*-------- Summary --------*/}
    <div className={`${!isCollapsed  ? 'hidden' : 'block'} mx-auto xl:block`}>
    <div className="min-w-100 border mx-auto xl:mx-30 mt-25 mb-2 p-6 rounded-lg space-y-6 bg-white shadow-md">
    <h2 className="text-2xl font-bold text-gray-800">Price Details :</h2>
    <div>
    <div className="space-y-1">
    <div className="flex justify-between">
      <div>
        <p className="text-lg  font-semibold text-gray-700">Item Price {' '}
      <span className="items-center gap-2">
      (x{bookingData.services.length})
    </span>:</p>
      </div>
...
<div className="flex items-center xl:ml-28 space-x-2 mt-4">
        <input
          type="checkbox"
          id="terms"
          checked={isChecked}
          onChange={handleCheckboxChange}
          className="h-5 w-5 text-indigo-600 border-gray-300 rounded shrink-0"
        />
   ...
   {/*{isCollapsed && (
    <div className="hidden md:mx-auto">
