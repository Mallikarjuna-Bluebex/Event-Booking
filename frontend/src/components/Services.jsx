...
>
      <div>
      <h1 className='text-3xl text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 font-bold mx-4 lg:mx-10 mt-5'>Elements Photo Shoots</h1>
