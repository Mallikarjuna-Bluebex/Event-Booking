...
export const EventProvider = ({ children }) => {
    ...
    const addNewCategory = async (newCategory) => {
        try {
            const response = await axios.post(backendUrl+'/api/admin/add-event', { category: newCategory });
    ...
    const addEvent = async (eventData) => {
        try {
            await axios.post(backendUrl+'/api/admin/add-event', eventData);
    ...
    return (
        <EventContext.Provider value={{ token, categories, setCategories,  selectedDate, categoriesFilter,  bookedServiceEvents, setBookedServiceEvents, setSelectedDate, setCategoriesFilter, addNewCategory, addEvent,showInvoice,setShowInvoice, userData, setUserData,  }}>
            {children}
