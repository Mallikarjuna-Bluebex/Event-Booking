...
const Login = () => {
  ...
  return (
   ...
   <div className='flex flex-col bg-white/20 backdrop-blur-sm gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 text-zinc-600 rounded-xl text-sm shadow-2xl'>
        ...
        <button type="submit" className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white w-full py-2 rounded-md text-base font-semibold flex items-center justify-center" disabled={loading}>
        {loading ? (
